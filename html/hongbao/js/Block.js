...
Block.prototype.end = function(){
	...
	if( !document.getElementById("againMask") ){
	 ...
	 // againMask.innerHTML =
		'<div id="gove" ><h2 id="againSum">哇塞!你只抢到了'+_t.sum+'红包</h2><h1>难道是大神没附体!</h1><span id="againStart"><img src="hongbao/img/e1.png"></span><span id="againStart_two"><img src="hongbao/img/e2.png"></span><div>';
...
if(_t.sum>=5){
		againMask.innerHTML =
		'<div id="gove" ><h2 id="againSum">哇抢到了'+_t.sum+'红包</h2><h1>好哈哈好啊难附体!</h1><span id="againStart"><img src="hongbao/img/e1.png"></span><span id="againStart_two"><img src="hongbao/img/e2.png"></span><div>';
